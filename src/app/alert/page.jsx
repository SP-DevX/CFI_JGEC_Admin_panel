                    ...
                    <Table hoverable>
                        ...
                        <Table.Body className="divnamee-y">
                            <Table.Row className="bg-white">
                                ...
                                <Table.Cell>swadesh pal</Table.Cell>
                                ...
                                <Table.Cell>
                                    <Button color="success">Solve</Button></Table.Cell>
                                <Table.Cell >
                                    <div className="flex text-xl items-center">
                                        <div className=' cursor-pointer text-green-500 hover:bg-gray-200 p-2 rounded-full ' onClick={() => updateAlumni(item)}>
                                            <FaUserEdit />
                                        </div>
                                        <div className='cursor-pointer text-red-500 hover:bg-gray-200 p-2 rounded-full ' onClick={() => deleteAlumniDetails(item)}>
                                            <MdDelete />
                                        </div>
                                    </div>
                                </Table.Cell>
